...
export const ERISIM_MATRISI = {
    ...
    '/arge': { tam: 'full', uretim: 'full', genel: null },
    '/kumas': { tam: 'full', uretim: 'full', genel: null },
    '/kalip': { tam: 'full', uretim: 'full', genel: null },
    '/modelhane': { tam: 'full', uretim: 'full', genel: null },
    '/kesim': { tam: 'full', uretim: 'full', genel: 'read' },
    '/uretim': { tam: 'full', uretim: 'full', genel: 'read' },
    '/maliyet': { tam: 'full', uretim: 'read', genel: null },
    '/muhasebe': { tam: 'full', uretim: null, genel: null },
    '/katalog': { tam: 'full', uretim: 'full', genel: null },
    '/siparisler': { tam: 'full', uretim: 'full', genel: null },
    '/stok': { tam: 'full', uretim: 'full', genel: 'read' },
    '/kasa': { tam: 'full', uretim: null, genel: null },
    '/musteriler': { tam: 'full', uretim: 'full', genel: null },
    '/personel': { tam: 'full', uretim: 'read', genel: null },
    '/guvenlik': { tam: 'full', uretim: null, genel: null },
    '/raporlar': { tam: 'full', uretim: 'read', genel: null },
